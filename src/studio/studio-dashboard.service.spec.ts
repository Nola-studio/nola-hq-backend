...
describe('StudioDashboardService', () => {
  ...
  test('computes KPIs, groupings and the activity heatmap from a single aggregate call', async () => {
    const tasks = [
      { id: 't1', identifier: 'YEK-1', title: 'A', status: 'in_progress', assigneeEmail: 'a@nola.dev', dueDate: '2026-08-20', completedAt: null },
      { id: 't2', identifier: 'YEK-2', title: 'B', status: 'in_review', assigneeEmail: 'a@nola.dev', dueDate: '2026-08-01', completedAt: null },
      { id: 't3', identifier: 'YEK-3', title: 'C', status: 'done', assigneeEmail: null, dueDate: '2026-08-10', completedAt: new Date('2026-08-14T00:00:00Z') },
    ];
    const expenses = [
